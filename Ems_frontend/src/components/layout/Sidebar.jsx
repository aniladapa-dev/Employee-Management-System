          ...
          <div className={clsx(
            ...
            <div className={clsx("flex items-center", isCollapsed ? "lg:justify-center gap-3 lg:gap-0" : "gap-3")}>
              <button 
                ...
                className="w-8 h-8 rounded-lg bg-primary-600 flex-shrink-0 flex items-center justify-center text-white font-bold transition-transform hover:scale-105 active:scale-95 focus:outline-none"
